...
describe('TCP Modbus Request Tests', function () {
  ...
  describe('Write multiple coils tests.', function () {
    ...
    it('should write a tcp request with array values.', function () {
      ...
      let requestBuffer = Buffer.from([0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x03, 0x0F, 0x12, 0x34, 0x00, 0x09, 0x02, 0xdd, 0x00])
    ...
    it('should write a tcp request with buffer.', function () {
      ...
      let requestBuffer = Buffer.from([0x00, 0x01, 0x00, 0x00, 0x00, 0x09, 0x03, 0x0F, 0x12, 0x34, 0x00, 0x09, 0x02, 0x00, 0xdd])
  ...
  describe('Write Multiple Registers Tests.', function () {
    ...
    it('should write a tcp request with array values.', function () {
      ...
      let requestBuffer = Buffer.from([0x00, 0x01, 0x00, 0x00, 0x00, 0x0F, 0x03, 0x10, 0x12, 0x34, 0x00, 0x04, 0x08, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x43, 0x21])
