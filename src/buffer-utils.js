...
function bufferShift(start_address, end_address, outputs) {
...
*/
function firstByte(start_address, original_byte, output_byte) {
    start_address = start_address - 1
    let start_shift = start_address % 8
...
*/
function lastByte(end_address, original_byte, output_byte) {
